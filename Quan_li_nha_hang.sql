...
CREATE TABLE HOA_DON (
	...
	CONSTRAINT CK_LOAIHOADON CHECK (LOAI_HOADON IN (N'TRỰC TIẾP' , N'ONLINE')),
...
CREATE TABLE CHI_NHANH (
    ...
    TG_DONG TIME,
    SDT CHAR(10),
    BD_XEMAY NVARCHAR(10) CONSTRAINT CK_CN_XM CHECK (BD_XEMAY IN(N'CÒN', N'HẾT')),
    BD_XEHOI NVARCHAR(10) CONSTRAINT CK_CN_XH CHECK (BD_XEHOI IN(N'CÒN' ,N'HẾT')),
    DIACHI NVARCHAR(255),
...
ALTER TABLE HOA_DON
ADD CONSTRAINT FK_HOADON3 FOREIGN KEY (MA_CHINHANH)
