...
CREATE TABLE KHACH_HANG (
    ...
    EMAIL VARCHAR(100),
    CCCD CHAR(12),
    GIOITINH NVARCHAR(3) CONSTRAINT CK_GIOITINH CHECK (GIOITINH IN ('Male', 'Female')),
    DIACHI NVARCHAR(50),
...
CREATE TABLE CHI_TIET_PHIEU (
	...
	CONSTRAINT CK_CTPD_TT CHECK (TRANG_THAI IN ( 'PROCESSING','DELIVERED')),
...
CREATE TABLE HOA_DON (
	...
	CONSTRAINT CK_LOAIHOADON CHECK (LOAI_HOADON IN ('IN-PERSON' , 'ONLINE')),
...
CREATE TABLE CHI_NHANH (
    ...
    TG_DONG TIME,
    SDT CHAR(10),
    BD_XEMAY NVARCHAR(10) CONSTRAINT CK_CN_XM CHECK (BD_XEMAY IN('STILL', 'OUT OF')),
    BD_XEHOI NVARCHAR(10) CONSTRAINT CK_CN_XH CHECK (BD_XEHOI IN('STILL' ,'OUT OF')),
    DIACHI NVARCHAR(255),
...
CREATE TABLE DOANH_THU (
    ...
    DOANH_THU FLOAT,
    NGAY DATE,
	CONSTRAINT PK_DOANHTHU  PRIMARY KEY (MA_DOANHTHU, MA_HOADON)
);
--PK: MA_CHINHANH
-- Table: THUC_DON
...
ALTER TABLE DOANH_THU
ADD CONSTRAINT FK_DOANHTHU2 FOREIGN KEY (MA_HOADON)
REFERENCES HOA_DON (MA_HOADON)
