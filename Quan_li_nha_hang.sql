-- Script to create relational database schema
USE master
GO
...
CREATE TABLE KHACH_HANG (
    ...
    EMAIL VARCHAR(100),
    CCCD CHAR(12),
    GIOITINH NVARCHAR(3) CONSTRAINT CK_GIOITINH CHECK (GIOITINH IN ('Nam', 'Nữ')),
    DIACHI NVARCHAR(50),
	MA_THE CHAR(10),
...
CREATE TABLE PHIEU_DAT (
    ...
    NGAY_DAT DATE,
    NGAY_BAN DATE,
	CONSTRAINT CK_PD_NGAY CHECK (NGAY_DAT <= NGAY_BAN),
...
CREATE TABLE CHI_TIET_PHIEU (
	...
	CONSTRAINT CK_CTPD_TT CHECK (TRANG_THAI IN ( 'ĐANG XỬ LÍ','ĐÃ GIAO')),
	CONSTRAINT PK_CHITIETPHIEUDAT PRIMARY KEY (MA_CTPHIEU)
);
--PK: MA_PHIEU, MA_MON
...
CREATE TABLE DON_HANG_ONLINE (
    MA_DONHANG CHAR(10),
    MA_KH CHAR(10),
	MA_CTDONHANG CHAR(10),
    NGAY_DAT DATE,
    TRANGTHAI NVARCHAR(50),
    MA_TAIXE CHAR(10),
	CONSTRAINT PK_DONHANGONLINE PRIMARY KEY (MA_DONHANG, MA_CTDONHANG)
);
--PK: MA_KH, MA_CTDONHANG, MA_TAIXE
-- Table: CHI_TIET_DON_HANG_ONLINE
CREATE TABLE CHI_TIET_DON_HANG_ONLINE (
    MA_CTDONHANG CHAR(10),
    MA_MON CHAR(10),
    SO_LUONG INT,
	CONSTRAINT PK_CTDONHANG PRIMARY KEY (MA_CTDONHANG)
);
--PK: MA_MON
-- Table: HOA_DON
CREATE TABLE HOA_DON (
	...
	CONSTRAINT PK_HOADON PRIMARY KEY (MA_HOADON, MA_DONHANG, MA_CTDONHANG)
);
...
CREATE TABLE DOANH_THU (
    ...
    DOANH_THU FLOAT,
    NGAY DATE,
	CONSTRAINT PK_DOANHTHU  PRIMARY KEY (MA_DOANHTHU, MA_HOADON,MA_DONHANG, MA_CTDONHANG)
);
--PK: MA_CHINHANH
-- Table: THUC_DON
...
ADD CONSTRAINT FK_KHACHHANG FOREIGN KEY (MA_THE)
REFERENCES THE_THANH_VIEN (MA_THE)

ALTER TABLE THE_THANH_VIEN
ADD CONSTRAINT FK_THETHANHVIEN FOREIGN KEY (MA_NV)
...
ALTER TABLE DON_HANG_ONLINE
ADD CONSTRAINT FK_DONHANG2 FOREIGN KEY (MA_CTDONHANG)
REFERENCES CHI_TIET_DON_HANG_ONLINE (MA_CTDONHANG)

ALTER TABLE DON_HANG_ONLINE
ADD CONSTRAINT FK_DONHANG3 FOREIGN KEY (MA_TAIXE)
REFERENCES TAI_XE (MA_TAIXE)

ALTER TABLE CHI_TIET_DON_HANG_ONLINE
ADD CONSTRAINT FK_CTDONHANG FOREIGN KEY (MA_MON)
REFERENCES MON_AN (MA_MON)

ALTER TABLE HOA_DON
ADD CONSTRAINT FK_HOADON1 FOREIGN KEY (MA_DONHANG, MA_CTDONHANG)
REFERENCES DON_HANG_ONLINE (MA_DONHANG, MA_CTDONHANG)
...
ALTER TABLE DOANH_THU
ADD CONSTRAINT FK_DOANHTHU2 FOREIGN KEY (MA_HOADON,MA_DONHANG, MA_CTDONHANG)
REFERENCES HOA_DON ( MA_HOADON,MA_DONHANG, MA_CTDONHANG)
